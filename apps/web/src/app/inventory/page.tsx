  ...
  return (
    <div className={styles.container}>
      ...
      <nav className={styles.tabbar}>
        ...
        <button className={styles.tabItem} data-active="true" onClick={() => router.push("/inventory")}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 8V21H3V8" />
            <path d="M1 3h22v5H1z" />
            <path d="M10 12h4" />
        ...
        <button className={styles.tabItem} data-active="false" onClick={() => router.push("/settings")}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
